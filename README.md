...
| 数据库     | Go     | [CrateDB](https://github.com/crate/crate)                                           | 分布式时序数据库            | OBS                                          | v5.9                             |      |
...
| 通用应用    | Python | [DataX](https://github.com/alibaba/DataX)                                           | 异构数据同步工具            | OBS                                          | v4.0                             |      |
| 通用应用    | Python | [Airbyte](https://github.com/airbytehq/airbyte)                                     | 数据同步与整合             | OBS、DWS                                      | v0.68                            |      |
| 通用应用    | Python | [Vault](https://github.com/hashicorp/vault)                                         | 密钥与凭证管理             | OBS、IAM                                      | v1.17                            |      |
| 通用应用    | Python | [Chaos Genius](https://github.com/chaos-genius/chaos_genius)                        | 异常检测与分析             | DWS（PostgreSQL）                              | v0.6                             |      |
| 通用应用    | Python | [StreamSets](https://github.com/streamsets/datacollector)                           | 数据流采集平台             | OBS                                          | v5.11                            |      |
...
| 通用应用    | Java   | [JuiceFS](https://github.com/juicedata/juicefs)                                     | 分布式文件系统             | OBS                                          | v1.2                             |      |
